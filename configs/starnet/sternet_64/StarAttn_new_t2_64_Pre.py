...
# =========> model <=================================
model = _Namespace()
model.name = 'StarNet_MHSA_T2_64_DTW_Pre'
...
trainer.checkpoint = 'runs/starnet_64/StarNet_t2_64_Pre'
trainer.resume_dir = ''
trainer.cuda_deterministic = False
trainer.epoch_full = epoch_full
trainer.scheduler_kwargs = dict(
	name='cosine', lr_noise=None, noise_pct=0.67, noise_std=1.0, noise_seed=42, lr_min=min_lr,
	warmup_lr=warmup_lr, warmup_iters=-1, cooldown_iters=0, warmup_epochs=warmup_epochs, cooldown_epochs=0, use_iters=True,
...
trainer.data.num_workers_per_gpu = 16
