...
# =========> model <=================================
model = _Namespace()
model.name = 'StarNet_T4_NEW_CONV_224_MLP1'
...
trainer.scheduler_kwargs = dict(
	name='cosine', lr_noise=None, noise_pct=0.67, noise_std=1.0, noise_seed=42, lr_min=lr / 1e2,
	warmup_lr=lr / (3*1e3), warmup_iters=-1, cooldown_iters=0, warmup_epochs=warmup_epochs, cooldown_epochs=0, use_iters=True,
